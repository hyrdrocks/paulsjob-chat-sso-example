...
&nbsp;·&nbsp;
**📖 [Read the integration guide](https://hyrdrocks.github.io/paulsjob-chat-sso-example/)** — the full walkthrough.
Print it to PDF from your browser if you need to send it on.
...
| `docs/index.html` | The guide (published at the link above). |
